...
namespace vanterbit\modules\UserManagement;
...
class UserManagementModule extends \yii\base\Module
{
	 ...
	 * @var string
	 */
	public $registrationFormClass = 'vanterbit\modules\UserManagement\models\forms\RegistrationForm';
	...
	public $controllerNamespace = 'vanterbit\modules\UserManagement\controllers';
	...
	public static function t($category, $message, $params = [], $language = null)
	{
		if ( !isset(Yii::$app->i18n->translations['modules/user-management/*']) )
		{
			Yii::$app->i18n->translations['modules/user-management/*'] = [
				...
				'sourceLanguage' => 'en',
				'basePath'       => '@vendor/vanterbit/module-user-management/messages',
				'fileMap'        => [
