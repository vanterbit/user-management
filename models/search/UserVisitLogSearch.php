...
namespace vanterbit\modules\UserManagement\models\search;
...
/**
 * UserVisitLogSearch represents the model behind the search form about `vanterbit\modules\UserManagement\models\UserVisitLog`.
 */
